...
import {
  ...
  Inbox, Send, Pin, TrendingUp, BarChart3,
} from "lucide-react";
...
export default function ReportsPage() {
  ...
  const { inbox, sent, drafts, forwarded, pinnedIds, unreadCount } = useAnnouncements();
    ...
    <div className="p-6 space-y-6 overflow-y-auto h-full">
      ...
      <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
        <div className="flex items-center gap-2 px-5 pt-4 pb-1">
          ...
          <h3 className="text-sm font-semibold text-foreground">Announcement Activity</h3>
        </div>
        <AnnouncementActivityChart />
      </div>
    </div>
