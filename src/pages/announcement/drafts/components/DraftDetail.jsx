...
function RecipientDisplay({ recipients, recipientLabel, onShowAll }) {
  ...
  return (
    <div className="flex items-center gap-1.5 text-xs text-muted-foreground">
      ...
      {recipientLabel
        ? <span className="text-foreground">{recipientLabel}</span>
    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center gap-4 bg-background">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1">Select a draft to view or continue editing</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex-1 min-h-0 overflow-y-auto">
        <div className="px-8 py-8">
          ...
          <div className="flex items-start gap-3 pb-5 border-b border-border">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2">
                <span className="text-sm font-semibold text-foreground truncate">{selected.sender || "You"}</span>
          ...
          {selected.content ? (
            ...
            <span className="italic text-muted-foreground/40 text-sm mt-6 block">No content yet</span>
          )}
